...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" nonce="<?= $nonce ?>">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" rel="stylesheet" nonce="<?= $nonce ?>">
  ...
  <div class="container-fluid">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <span class="text-secondary small">
        <?= clean($name) ?>
        <span class="nm-badge ms-1 <?= is_admin() ? '' : 'nm-badge-unknown' ?>"
              style="<?= is_admin() ? 'background:rgba(188,140,255,.15);color:#bc8cff;border:1px solid rgba(188,140,255,.3)' : '' ?>">
          <?= $role ?>
        </span>
      </span>
